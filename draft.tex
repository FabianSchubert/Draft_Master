...
\subsubsection{Former Single-Cell Homeostasis as an Integral Control}
...
Still, estimating an power-law exponent based on the given data required setting an upper and lower limit over which 

 This feature was preserved under diffusive homeostasis, as shown in Figure \ref{Syn_Lifetimes}. The resulting slopes are within previously reported values of $\mathrm{\approx - 5/3}$ \cite{SORN_Paper}.
\begin{figure}
