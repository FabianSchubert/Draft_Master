...
\end{equation}
If membrane noise is present, according to \cite{Roxin_Firing_Rate_Distribution} one can calculate the \emph{mean} firing rate by
\begin{equation}
\phi(J) = 
\label{LIF_Fir_Rate_with_Noise}
\end{equation}
