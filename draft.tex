...
\caption{Distribution of lifetimes of recurrent excitatory synaptic connections. Linear fits ignoring falloff for large synaptic lifetimes resulted in a slope of $\mathrm{-1.87}$ for diffusive homeostasis and $\mathrm{-1.68}$ for non-diffusive homeostasis.}
\label{Syn_Lifetimes}
\end{figure}
